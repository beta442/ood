#ifndef COMMAND_DOCUMENT_COMMANDS_INSERT_DOCUMENT_ITEM_H_
#define COMMAND_DOCUMENT_COMMANDS_INSERT_DOCUMENT_ITEM_H_
...
#endif // !COMMAND_DOCUMENT_COMMANDS_INSERT_PARAGRAPH_H_
